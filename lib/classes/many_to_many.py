...
# Create authors
author1 = Author("Hamza")
author2 = Author("Myself")
...
# Create articles
article1 = Article(author1, mag1, "Please Help")
article2 = Article(author1, mag1, "Trust the process")
article3 = Article(author2, mag2, "my life")
article4 = Article(author1, mag2, "Nutrition Facts 101")
article5 = Article(author2, mag1, "Exfactor")
